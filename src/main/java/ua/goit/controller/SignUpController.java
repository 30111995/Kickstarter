...
public class SignUpController {
  ...
  public String handleSignUpRequest(Model model, @RequestParam("name") String name, @RequestParam("login") String login, @RequestParam("password") String password, @RequestParam("email") String email) {
  ...
  public String handleActivation(Model model, @RequestParam(value = "key") String activationKey, HttpServletResponse response) {
